...
const Section1 = () => {
  const { SocialMedia, Introduction } = useData();
  ...
  return (
    <div className="my-24 ">
      <div className="relative">
        <div className="flex justify-center ">
          <div className=" d:h-[500px] d:w-[500px] p:w-[250px] p:h-[250px] overflow-hidden rounded-full shadow-xl">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/dora-a85b2.appspot.com/o/129244657_2906794326273893_50684295853266341_n.jpg?alt=media&token=ceaa24e9-b83d-4f41-bbc2-cfb0d16766f1"
              alt="avatar"
        ...
        <div>
          <div className="flex  gap-3 bg-white text-black rounded-full items-center d:py-5 p:py-2  d:px-10 p:px-4 d:text-[28px] p:text-[13px] absolute top-[40%] d:left-20 p:left-4 shadow-lg">
            <GiLifeBar />
            <p>Life Club</p>
          </div>
        </div>
        ...
        <div>
          <div className="flex  gap-3 bg-white text-black rounded-full items-center d:py-5 p:py-2  d:px-10 p:px-4 d:text-[28px] p:text-[13px] absolute top-[40%] d:right-16 p:right-4 shadow-lg">
            <FcBusinessman />
            <p>Alpha Leader</p>
          </div>
        </div>
      ...
      <div className="mt-20  border-gray-300 rounded-xl shadow-2xl ">
                  ...
                  <>
                    {Icon && (
                      <a
                        ...
                        target="_blank"
                      >
                        <Icon className=" hover:text-blue-500 hover:scale-125 duration-300   " />
                      </a>
                    )}
                  </>
                );
